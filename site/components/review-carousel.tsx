...
function ReviewCard(props: ReviewCardProps) {
  ...
  return (
    <CarouselItem className="shadow-md duration-150 hover:scale-[102%] md:basis-1/2 lg:basis-1/3">
    ...
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container grid grid-cols-1 gap-12 px-4 md:flex md:flex-col md:items-center md:px-6 lg:grid-cols-2">
        ...
        <Carousel className="w-full max-w-2xl lg:max-w-none">
          ...
          <CarouselPrevious className="absolute -left-6 top-1/2 z-10 -translate-y-1/2 rounded-full bg-accent/50 p-2 text-primary/50 shadow-lg transition-all hover:bg-accent hover:text-primary">
            <ChevronLeftIcon className="h-5 w-5 text-gray-900 dark:text-gray-50" />
          </CarouselPrevious>

          <CarouselNext className="absolute -right-6 top-1/2 z-10 -translate-y-1/2 rounded-full bg-accent/50 p-2 text-primary/50 shadow-lg transition-all hover:bg-accent hover:text-primary">
