...
export const Icons = {
  ...
  landlord: ({ ...props }: LucideProps) => (
    <svg
      ...
      stroke="currentColor"
      strokeWidth="1"
      className="lucide lucide-book-user size-12 fill-primary stroke-secondary"
    >
  ...
  umbrella: ({ ...props }: LucideProps) => (
    <svg
      ...
      strokeLinecap="round"
      // strokeLinejoin="round"
      className="lucide lucide-umbrella size-12 fill-current"
    >
  ...
  heart: ({ ...props }: LucideProps & { className?: string }) => (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      width="24"
